# 38_1 - 객체 생성을 자동화하는 IoC 컨테이너 만들기
...
- src/main/java/kny/cook/util/Component.java 추가
- src/main/java/kny/cook/util/ApplicationContext.java 추가
- src/main/java/kny/cook/service/impl/BoardServiceImpl2.java 삭제
- src/main/java/kny/cook/service/impl/XxxServiceImpl.java 변경
- src/main/java/kny/cook/servlet/XxxServlet.java 변경
- src/main/java/kny/cook/DataLoaderListener.java 의 이름 변경
  - ContextLoaderListener.java 로 이름 변경


### 작업1: IoC 컨테이너 클래스를 준비한다.(ApplicationContext01)

- kny.cook.util.ApplicationContext 클래스 생성

### 작업2: 특정 패키지의 파일 시스템 경로를 알아낸다.(ApplicationContext02)

- kny.cook.util.ApplicationContext 클래스 변경
  - 패키지명을 입력받아서 파일 시스템의 경로를 알아낸다.
- kny.cook.DataLoaderListener 의 이름 변경
...
- kny.cook.util.Component 애노테이션 추가
