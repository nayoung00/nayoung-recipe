<%@page import="kny.cook.domain.PhotoFile"%>
...
<jsp:useBean id="photoBoard" class="kny.cook.domain.PhotoBoard" scope="request"/>
...
수업: <%=photoBoard.getRecipe().getCook()%><br>
<hr>
사진 파일:<br>
<p>
<%
...
사진: <input name='photo' type='file'><br>
<p><button>변경</button>
<a href='delete?no=<%=photoBoard.getNo()%>&lessonNo=<%=photoBoard.getRecipe().getNo()%>'>삭제</a></p>
</form>
